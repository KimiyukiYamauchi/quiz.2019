...
$x = array(
    array(
        'select-img',
        'M',
        'LANの説明として、もっとも適切なものを選びなさい',
        'インターネット上で構築される仮想的なネットワーク',
        'WANを世界規模につなげたネットワーク',
        '家庭内や学校内といった限られた範囲に構成された小規模のネットワーク',
        '個々のネットワークを結ぶ広域のネットワーク',
        '',
        '',
        hash('sha256', json_encode('家庭内や学校内といった限られた範囲に構成された小規模のネットワーク')),
        '',
        '',
        ''
    ),
    ...
    array(
        'checkbox',
        'M',
        'SELECT文に ORDER BY ASC を指定してデータを検索した場合の動作として、 正しいものを2つ選択し てください',
        '数値は、小さい値が先に表示される',
        '日付は、新しい日付から先に表示される',
        '英字は、アルファベット順に表示される',
        'NULLは、最初に表示される',
        'わからない',
        '',
        hash('sha256', json_encode('数値は、小さい値が先に表示される英字は、アルファベット順に表示される')),
        '',
        5,
        2
    ),
...
for ($i = 0; $i < count($x); $i++) {
    ...
    $query = "INSERT INTO quiz4 VALUES (" .
        "'', '$oszlop1', '$oszlop2', '$oszlop3', '$oszlop4', '$oszlop5', " .
        "'$oszlop6', '$oszlop7', '$oszlop8', '$oszlop9', '$oszlop10', " .
        "'$oszlop11', '$oszlop12', '$oszlop13')";
    row_creator($query);
}
